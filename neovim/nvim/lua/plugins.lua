...
return require('packer').startup(function(use)
        ...
        --l -- Git decorations
        --l use { 'lewis6991/gitsigns.nvim', config = [[require('config.gitsigns')]] }
        ...
        --l -- File explorer
        --l use {
        --l     'nvim-tree/nvim-tree.lua',
        --l     requires = {
        --l         'nvim-tree/nvim-web-devicons', -- optional, for file icons
        --l     },
        --l     config = [[require('config.nvim-tree')]]
        --l }
